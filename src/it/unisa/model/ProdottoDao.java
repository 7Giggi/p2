...
public class ProdottoDao implements ProdottoDaoInterfaccia{
	...
	public synchronized ArrayList<ProdottoBean> doRetrieveAll(String order) throws SQLException {
		...
		List<String> orderList = Arrays.asList("id_prodotto","nome","descrizione","descrizione_dettagliata","iva","in_vendita","data_uscita","prezzo","quantita","immagine","piattaforma","genere");
